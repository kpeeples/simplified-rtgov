...
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/ordermgmt/ip; mvn -s /home/kpeeples/demos/fsw-simple-demo/support/settings.xml clean jboss-as:deploy)
echo "Install Orders Management from quickstarts/overlord/rtgov/ordermgmt/app"
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/ordermgmt/app; mvn -s /home/kpeeples/demos/fsw-simple-demo/support/settings.xml clean jboss-as:deploy)
...
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/policy/sync; mvn -s /home/kpeeples/demos/fsw-simple-demo/support/settings.xml clean jboss-as:deploy)
...
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/policy/async; mvn -s /home/kpeeples/demos/fsw-simple-demo/support/settings.xml clean jboss-as:deploy)
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/ordermgmt/app; mvn exec:java -Dreq=order1)
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/ordermgmt/app; mvn exec:java -Dreq=order1)
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/ordermgmt/app; mvn exec:java -Dreq=order1)
...
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/sla/epn; mvn -s /home/kpeeples/demos/fsw-simple-demo/support/settings.xml clean jboss-as:deploy)
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/sla/monitor; mvn -s /home/kpeeples/demos/fsw-simple-demo/support/settings.xml clean jboss-as:deploy)
...
read -p "Press [Enter] key to continue...Response from REST call"
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/sla/report; mvn -s /home/kpeeples/demos/fsw-simple-demo/support/settings.xml clean jboss-as:deploy)
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/ordermgmt/app; mvn exec:java -Dreq=order1)
(cd installed/fsw/jboss-eap-6.1/quickstarts/overlord/rtgov/ordermgmt/app; mvn exec:java -Dreq=order3)
